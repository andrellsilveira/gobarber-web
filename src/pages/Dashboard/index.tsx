...
/** Biblioteca para implementação de calendário */
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    api
      .get(`/providers/${user.id}/month-availability`, {
        /** O atributo "params" serve para definição dos query params para uma rota */
        params: {
  ...
  /**
   * O hook "useMemo" define um estado para o valor de uma variável que somente será alterado
   * se algum dos parâmetros informados no array de dependência sofrer alteração
   */
